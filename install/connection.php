...
try {
  ...
  $remoteConfig = json_decode(@file_get_contents("https://dooo.onebytesolution.com/GetConfig/$licence_code", false, $arrContextOptions));
  if($remoteConfig == "") {
    exit('Invalid Licence Code!');
  }

  $install_dir = 'temp/';
  $install_file = "public/uploads/Dooo235b.zip";
  ...
  folderCopy($install_dir, $_SERVER['DOCUMENT_ROOT']);
  deleteDirectory($install_dir, true);
  echo "Installed Successfully";

} catch(PDOException $e) {
  exit('Database Connection failed. Please Enter Database Credentials Correctly.');
}
