                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table table-striped"
                                        ...
                                        <thead>
                                            ...
                                            <tr style="background-color: rgb(238, 46, 71); color:white;">
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        return '<div class="btn-group mr-1" data-container="body">' +
                            '<button type="button" class="btn btn-secondary btn-sm dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Options <i class="mdi mdi-chevron-down"></i></button>' +
                            '<div class="dropdown-menu" style="" data-container="body">' +
                            '<a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#add_subscription_Modal" onclick="loadSubscriptionList(' + data + ')" href="#">Add Subscription</a>' +
                            '<a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#send_Notification_Modal" onclick="initNotification(' + data + ')" href="#">Send Notification</a>' +
                            '<a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#Edit_this_User_Modal" onclick="Load_User_Data(' + data + ')" href="#">Edit User</a>' +
                            '<a class="dropdown-item" onclick="Delete_User(' + data + ')" href="#">Delete User</a>' +
                            '</div></div>';
                    }
                },
                {
                ...
                }, // Email
                {
                    ...
                    render: function(data) {
                        ...
                        if (data == 2) return 'SubAdmin';
                        if (data == 3 || data == 4) return 'Editor';
                    }
                },
                {
                    "data": "6"
                ...
                {
                    "data": "7", // Subscription Expiration Date
                    render: function(data) {
                        var today = new Date();
                        var expDate = new Date(data);
                        var timeDiff = expDate - today;
